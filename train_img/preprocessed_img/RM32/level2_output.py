...
def calFeaturePoint(img,lt_x,lt_y,rd_x,rd_y,rate):
    ...
    Lm = cropfaceOrgan(img,level2_pts5,rate,side,lt_x,lt_y)
    return level2_pts5,side,Lm * 255
...
if __name__ == "__main__":
    ...
    for line in lines:
        ...
        point_x = ((float(words[13])-lt_x) * (39.0/side) - (point[0] - 39 * rate)) * (15 / (39 * rate * 2))
        point_y = ((float(words[14])-lt_y) * (39.0/side) - (point[1] - 39 * rate)) * (15 / (39 * rate * 2))
