...
if __name__ == "__main__":
    ...
    savepath = "/home/cmcc/Desktop/DCNNCascade_pts/train_img/processed_img/LE21/val/"
    fileout = "/home/cmcc/Desktop/DCNNCascade_pts/train_img/processed_img/LE21/test.list"
	...
	#need to be changed
        point_x =( (float(words[5])-lt_x) * (39.0/side) - (point[0] - 39 * rate) ) * (15.0 / (39 * rate * 2))
        point_y =( (float(words[6])-lt_y) * (39.0/side) - (point[1] - 39 * rate) ) * (15.0 / (39 * rate * 2))
    ...
    savepath = "/home/cmcc/Desktop/DCNNCascade_pts/train_img/processed_img/LE21/train/"
    fileout = "/home/cmcc/Desktop/DCNNCascade_pts/train_img/processed_img/LE21/train.list"
    fid.close()
    fid = open(filelist,'r')
    lines = fid.readlines()
    fid.close()
